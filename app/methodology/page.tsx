      ...
      <main className="py-10 sm:py-14">
        <Container>
          <div className="mx-auto max-w-3xl">
            <h1 className="text-3xl font-semibold tracking-tight text-[var(--text)]">How HRSignal Intelligence Score™ works</h1>
              ...
              <Card className="p-6">
                ...
                <div className="mt-2 space-y-2 text-sm text-[var(--text-muted)]">
                  <p>
                    ...
                    The Intelligence Score™ prioritizes signal quality that helps you validate these risks early.
                  </p>
                </div>
              </Card>
