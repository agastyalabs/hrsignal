...
function MenuGroup({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div>
      <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">{title}</div>
      <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">{children}</div>
    </div>
  );
}
...
function MenuLink({
  ...
  return (
    <Link
      href={href}
      onClick={onClick}
      className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300"
      role="menuitem"
    >
      {label}
    </Link>
...
function HeaderInner({ pathname }: { pathname: string }) {
  ...
  return (
    ...
    >
      <Container className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
        <Link href="/" className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300" aria-label="HRSignal home" onClick={() => setOpenMenu(null)}>
          <span className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
            <Image
        ...
        {pathname !== "/" ? (
          <form action="/tools" className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300" onSubmit={() => setOpenMenu(null)}>
            <input
              className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300"
              name="q"
        ...
        {/* Desktop nav */}
        <nav className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300" aria-label="Primary">
          ...
          {/* Categories menu */}
          <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
            <button
              type="button"
        ...
        >
          <svg viewBox="0 0 24 24" fill="none" className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300" aria-hidden="true">
            {mobileOpen ? (
      ...
      {/* Mobile menu sheet */}
      {mobileOpen ? (
        <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300" role="dialog" aria-modal="true">
          <button
            type="button"
            className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300"
          ...
          <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
            <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
              <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">Menu</div>
              <button
                type="button"
                className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300"
            ...
            <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
              <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                ...
                <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">Privacy-first. No automatic vendor sharing.</div>
              </div>

              <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                <details className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300" open>
                  <summary className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">Browse</summary>
                  <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                ...
                <details className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                  <summary className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">Categories</summary>
                  <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                ...
                <details className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                  <summary className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">Learn</summary>
                  <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                ...
                <details className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                  <summary className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">Tools to speed evaluation</summary>
                  <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                    <MenuLink
                ...
                <details className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
                  <summary className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">Legal</summary>
                  <div className="w-80 h-auto filter drop-shadow-[0_0_20px_rgba(16,185,129,0.8)] hover:drop-shadow-[0_0_30px_rgba(16,185,129,1)] transition-all duration-300">
