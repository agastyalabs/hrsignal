...
const variants: Record<Variant, string> = {
  primary:
    "bg-[var(--primary)] text-white shadow-[0_12px_34px_rgba(0,0,0,0.35)] hover:bg-[var(--primary-hover)] hover:-translate-y-0.5 hover:shadow-[0_18px_52px_rgba(16,185,129,0.18)] active:translate-y-0 active:shadow-[0_12px_34px_rgba(0,0,0,0.35)] disabled:bg-[rgba(255,255,255,0.10)] disabled:text-[rgba(247,249,255,0.55)]",
  secondary:
